...
bool main::Init()
{
	...
	// КРИТИЧЕСКОЕ ИСПРАВЛЕНИЕ: Инициализируем UI (MyGUI) до инициализации ввода (g_input),
	// чтобы MyGUI успел создать свои внутренние синглтоны (включая InputManager).
	g_ui.Init();
